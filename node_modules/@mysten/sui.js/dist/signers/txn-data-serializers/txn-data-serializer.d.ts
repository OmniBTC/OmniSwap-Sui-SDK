...
export interface TxnDataSerializer {
    ...
    newPaySui(signerAddress: SuiAddress, txn: PaySuiTransaction): Promise<Base64DataBuffer>;
    newPayAllSui(signerAddress: SuiAddress, txn: PayAllSuiTransaction): Promise<Base64DataBuffer>;
